...
class MultPlayerGamePageActivity : AppCompatActivity() {
    private lateinit var binding: ActivityMultPlayerGamePageBinding
...
// ...
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var dongu = 0
        binding = ActivityMultPlayerGamePageBinding.inflate(layoutInflater)
        ...
        object: CountDownTimer(millisInFuture,countDownInterval){
            ...
            override fun onTick(millisUntilFinished: Long) {
                ...
                //else {
                binding.textView21.setText(timeRemaining)
                //}
            }
        ...
        binding.imageView1.setOnClickListener{
            ...
            if(sayac == 0){
                ...
                val a=wrongCalculate(card2Int!!,
                    randomized[0]!!.cardsHpoint,card1Int!!,randomized[0]!!.cardsPoint,cardHoome!!,randomized[0]!!.cardsHome,cardImgs!!,randomized[0]!!.cardsImg)
                println(a)
            }
        }
        binding.imageView4.setOnClickListener{
            ...
            if(sayac == 0){
                ...
                val a=wrongCalculate(card2Int!!,randomized[1]!!.cardsHpoint,card1Int!!,randomized[1]!!.cardsPoint,cardHoome!!,randomized[1]!!.cardsHome,cardImgs!!,randomized[1]!!.cardsImg)
                println(a)
            }
        ...
        binding.imageView.setOnClickListener{
            ...
            if(sayac == 0){
                ...
                val a=wrongCalculate(card2Int!!,randomized[2]!!.cardsHpoint,card1Int!!,randomized[2]!!.cardsPoint,cardHoome!!,randomized[2]!!.cardsHome,cardImgs!!,randomized[2]!!.cardsImg)
                println(a)
            }
        }
        binding.imageView3.setOnClickListener{
            ...
            if(sayac == 0){
                ...
                val a=wrongCalculate(card2Int!!,randomized[3]!!.cardsHpoint,card1Int!!,randomized[3]!!.cardsPoint,cardHoome!!,randomized[3]!!.cardsHome, cardImgs!!,randomized[3]!!.cardsImg)
                println(a)
            }
        }
    ...
    fun wrongCalculate(homepoint : Int,homepoint2 : Int, cardPoint:Int,cardPoint2:Int,cardHome:String,cardHome2: String, cardImgIndex: Int, cardImgIndex2: Int): Int {
        if(cardHome.equals(cardHome2)){
            if (cardsArray[cardImgIndex].cardsName != cardsArray[cardImgIndex2].cardsName) {
                return (-(cardPoint + cardPoint2) / homepoint)
            }
            }
        else if (cardHome != cardHome2){
            return (-((cardPoint+cardPoint2)/2)*homepoint*homepoint2)
            }
        else{
            return  (2*(cardPoint)*(homepoint)*(resumeFromMillis/10))
        }
        return 0
    }
