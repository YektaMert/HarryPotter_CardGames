...
class GamePageActivityFour : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityGamePageFourBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        binding = ActivityGamePageFourBinding.inflate(layoutInflater)
        ...
        object: CountDownTimer(millisInFuture,countDownInterval){
            ...
            override fun onTick(millisUntilFinished: Long) {
                ...
                //else {
                binding.textView3.setText(timeRemaining)
                //}
            }
        ...
        */
        ...
        binding.imageView4.setOnClickListener{
            ...
            if(sayac == 0){
                ...
                sayac=0
                cardMatch(randomized[3]!!.cardsImg,firstCardIndex!!.cardsImg,binding.imageView4, firstCardImageView!!)
        ...
        binding.imageView5.setOnClickListener{
            ...
            if(sayac == 0){
                ...
                sayac=0
                cardMatch(randomized[4]!!.cardsImg,firstCardIndex!!.cardsImg,binding.imageView5, firstCardImageView!!)
        ...
        binding.imageView6.setOnClickListener{
            ...
            if(sayac == 0){
                ...
                sayac=0
                cardMatch(randomized[5]!!.cardsImg,firstCardIndex!!.cardsImg,binding.imageView6, firstCardImageView!!)
        ...
        binding.imageView7.setOnClickListener{
            ...
            if(sayac == 0){
                ...
                sayac=0
                cardMatch(randomized[6]!!.cardsImg,firstCardIndex!!.cardsImg,binding.imageView7, firstCardImageView!!)
        ...
        binding.imageView8.setOnClickListener{
            ...
            if(sayac == 0){
                ...
                sayac=0
                cardMatch(randomized[7]!!.cardsImg,firstCardIndex!!.cardsImg,binding.imageView8, firstCardImageView!!)
        ...
        binding.imageView9.setOnClickListener{
            ...
            if(sayac == 0){
                ...
                sayac=0
                cardMatch(randomized[8]!!.cardsImg,firstCardIndex!!.cardsImg,binding.imageView9, firstCardImageView!!)
        ...
        binding.imageView10.setOnClickListener{
            ...
            if(sayac == 0){
                ...
                sayac=0
                cardMatch(randomized[9]!!.cardsImg,firstCardIndex!!.cardsImg,binding.imageView10, firstCardImageView!!)
        ...
        binding.imageView11.setOnClickListener{
            ...
            if(sayac == 0){
                ...
                sayac=0
                cardMatch(randomized[10]!!.cardsImg,firstCardIndex!!.cardsImg,binding.imageView11, firstCardImageView!!)
        ...
        binding.imageView12.setOnClickListener{
            ...
            if(sayac == 0){
                ...
                sayac=0
                cardMatch(randomized[11]!!.cardsImg,firstCardIndex!!.cardsImg,binding.imageView12, firstCardImageView!!)
        ...
        binding.imageView13.setOnClickListener{
            ...
            if(sayac == 0){
                ...
                sayac=0
                cardMatch(randomized[12]!!.cardsImg,firstCardIndex!!.cardsImg,binding.imageView13, firstCardImageView!!)
        ...
        binding.imageView14.setOnClickListener{
            ...
            if(sayac == 0){
                ...
                sayac=0
                cardMatch(randomized[13]!!.cardsImg,firstCardIndex!!.cardsImg,binding.imageView14, firstCardImageView!!)
        ...
        binding.imageView15.setOnClickListener{
            ...
            if(sayac == 0){
                ...
                sayac=0
                cardMatch(randomized[14]!!.cardsImg,firstCardIndex!!.cardsImg,binding.imageView15, firstCardImageView!!)
        ...
        binding.imageView16.setOnClickListener{
            ...
            if(sayac == 0){
                ...
                sayac=0
                cardMatch(randomized[15]!!.cardsImg,firstCardIndex!!.cardsImg,binding.imageView16, firstCardImageView!!)
