...
class GamePageActivitySix : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityGamePageSixBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        binding = ActivityGamePageSixBinding.inflate(layoutInflater)
        ...
        object: CountDownTimer(millisInFuture,countDownInterval){
            ...
            override fun onTick(millisUntilFinished: Long) {
                ...
                //else {
                binding.textView20.setText(timeRemaining)
                //}
            }
